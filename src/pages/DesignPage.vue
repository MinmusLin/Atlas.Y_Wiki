<template>
  <TextContent title='DESIGN'
               :title-list="['Overview', 'Database', 'Structure Prediction', 'Evaluation Metrics', 'Subcellular Localization Prediction', 'Protein Directed Evolution Model']">
    ...
    <p>In the Atlas.Y platform, we design fusion proteins that can be precisely localized to specific subcellular
      ...
      impact the functionality of the original proteins. Therefore, we developed the CAD (<span class='bold'>Contact
        Area Difference</span>) model to evaluate the <span class='bold'>functional changes</span> in fusion proteins.
    </p>
